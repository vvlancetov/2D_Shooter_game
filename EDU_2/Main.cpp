...
int main(int argc, char* argv[])
{
    ...
    while (main_window.isOpen())
    {
        ...
        if (game_state == States::EVACUATION)
        {
            ...
            // Коды возврата: 0 - ничего   1 - переход на главное меню (временно)
        ...
        if (game_state == States::BASE)
        {
            ...
            // Коды возврата: 0 - ничего   1 - продолжение игры
        ...
        if (game_state == States::DEATH)
        {
            ...
            // Коды возврата: 0 - ничего   1 - возврат на базу 2 - возврат в меню (временно)
